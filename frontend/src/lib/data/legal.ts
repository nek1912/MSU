...
export const legalDocs: LegalDoc[] = [
  {
    slug: "mscs-act-2002",
    title: { en: "Multi-State Cooperative Societies Act, 2002", gu: "મલ્ટી-રાજ્ય સહકારી સોસાયટી અધિનિયમ, 2002", pa: "ਮਲਟੀ-ਸਟੇਟ ਸਹਿਕਾਰੀ ਸੋਸਾਇਟੀਆਂ ਐਕਟ, 2002", te: "మల్టీ-స్టేట్ సహకార సొసైటీల చట్టం, 2002", kn: "ಮಲ್ಟಿ-ರಾಜ್ಯ ಸಹಕಾರ ಸೊಸೈಟಿಗಳ ಕಾಯಿದೆ, 2002", or: "ମଲ୍ଟି-ରାଜ୍ୟ ସହକାରୀ ସୋସାଇଟି ଅଧିନିୟମ, 2002" },
    badge: { en: "MSCS Act 2002", gu: "MSCS અધિનિયમ 2002", pa: "MSCS ਐਕਟ 2002", te: "MSCS చట్టం 2002", kn: "MSCS ಕಾಯಿದೆ 2002", or: "MSCS ଅଧିନିୟମ 2002" },
    category: "act",
    overview: {
    ...
    source: { label: { en: "Ministry of Cooperation", gu: "સહકાર મંત્રાલય", pa: "ਸਹਿਕਾਰਿਤਾ ਮੰਤਰਾਲਾ", te: "సహకార మంత్రిత్వ శాఖ", kn: "ಸಹಕಾರ ಸಚಿವಾಲಯ", or: "ସହକାର ମନ୍ତ୍ରାଳୟ" }, url: "https://www.moc.gov.in" },
  },
  {
    ...
    badge: { en: "Model PACS Bye-laws", gu: "મોડેલ PACS ઉપ-નિયમો", pa: "ਨਮੂਨਾ PACS ਉਪ-ਨਿਯਮ", te: "నమూనా PACS ఉప-నియమాలు", kn: "ಮಾದರಿ PACS ಉಪ-నಿಯಮಗಳು", or: "ଆଦର୍ଶ PACS ଉପ-ନିୟମ" },
    category: "bye-laws",
    overview: {
  ...
  },
  {
    ...
    title: { en: "Election of Board of Directors — MSCS Rules, 2011", gu: "સંચાલક મંડળની ચૂંટણી — MSCS નિયમો, 2011", pa: "ਨਿਰਦੇਸ਼ਕ ਬੋਰਡ ਦੀ ਚੋਣ — MSCS ਨਿਯਮ, 2011", te: "డైరెక్టర్ల బోర్డు ఎన్నిక — MSCS నిబంధనలు, 2011", kn: "ನಿರ್ದೇಶಕರ ಮಂಡಳಿಯ ಚುನಾವಣೆ — MSCS ನಿಯಮಗಳು, 2011", or: "ପରିଚାଳକ ବୋର୍ଡର ନିର୍ବାଚନ — MSCS ନିୟମ, 2011" },
    badge: { en: "Board Elections", gu: "મંડળ ચૂંટણીઓ", pa: "ਬੋਰਡ ਚੋਣਾਂ", te: "బోర్డు ఎన్నికలు", kn: "ಮಂಡಳಿ ಚುನಾವಣೆಗಳು", or: "ବୋର୍ଡ ନିର୍ବାଚନ" },
    category: "provisions",
    overview: {
  ...
  },
  {
    ...
    title: { en: "Cooperative Dispute Resolution", gu: "સહકારી વિવાદ નિવારણ", pa: "ਸਹਿਕਾਰੀ ਵਿਵਾਦ ਨਿਵਾਰਣ", te: "సహకార వివాద పరిష్కారం", kn: "ಸಹಕಾರ ವಿವಾದ ಪರಿಹಾರ", or: "ସହକାରୀ ବିବାଦ ସମାଧାନ" },
    badge: { en: "Disputes", gu: "વિવાદો", pa: "ਵਿਵਾਦ", te: "వివాదాలు", kn: "ವಿವಾದಗಳು", or: "ବିବାଦଗୁଡ଼ିକ" },
    category: "provisions",
    overview: {
    ...
    byLaws: { en: ["By-laws may prescribe an internal grievance-cum-dispute resolution committee."], gu: ["ઉપ-નિયમો આંતરિક ફરિયાદ-અને-વિવાદ નિવારણ સમિતિ નિર્ધારિત કરી શકે છે."], pa: ["ਉਪ-ਨਿਯਮ ਅੰਦਰੂਨੀ ਸ਼ਿਕਾਇਤ-ਸਹਿਤ-ਵਿਵਾਦ ਨਿਵਾਰਣ ਕਮੇਟੀ ਨਿਰਧਾਰਤ ਕਰ ਸਕਦੇ ਹਨ।"], te: ["ఉప-నియమాలు అంతర్గత ఫిర్యాదు-సహిత-వివాద పరిష్కార కమిటీని నిర్దేశించవచ్చు."], kn: ["ಉಪ-ನಿಯಮಗಳು ಆಂತರಿಕ ದೂರು-ಮತ್ತು-ವಿವಾದ ಪರಿಹಾರ ಸಮಿತಿಯನ್ನು ನಿಗದಿಪಡಿಸಬಹುದು."], or: ["ଉପ-ନିୟମ ଆନ୍ତରିକ ଅଭିଯୋଗ-ଏବଂ-ବିବାଦ ସମାଧାନ କମିଟି ନିର୍ଦ୍ଧାରଣ କରିପାରେ।"] },
    source: { label: { en: "Ministry of Cooperation", gu: "સહકાર મંત્રાલય", pa: "ਸਹਿਕਾਰਿਤਾ ਮੰਤਰਾਲਾ", te: "సహకార మంత్రిత్వ శాఖ", kn: "ಸಹಕಾರ ಸಚಿವಾಲಯ", or: "ସହକାର ମନ୍ତ୍ରାଳୟ" }, url: "https://www.moc.gov.in" },
  },
  {
    slug: "pac-model-bye-laws-moc",
    title: { en: "Model Bye-laws for PACS — Ministry of Cooperation", gu: "PACS માટે મોડેલ ઉપ-નિયમો — સહકાર મંત્રાલય", pa: "PACS ਲਈ ਨਮੂਨਾ ਉਪ-ਨਿਯਮ — ਸਹਿਕਾਰਿਤਾ ਮੰਤਰਾਲਾ", te: "PACS కోసం నమూనా ఉప-నియమాలు — సహకార మంత్రిత్వ శాఖ", kn: "PACS ಗಾಗಿ ಮಾದರಿ ಉಪ-ನಿಯಮಗಳು — ಸಹಕಾರ ಸಚಿವಾಲಯ", or: "PACS ପାଇଁ ଆଦର୍ଶ ଉପ-ନିୟମ — ସହକାର ମନ୍ତ୍ରାଳୟ" },
    badge: { en: "PACS Bye-laws (MoC)", gu: "PACS ઉપ-નિયમો (MoC)", pa: "PACS ਉਪ-ਨਿਯਮ (MoC)", te: "PACS ఉప-నియమాలు (MoC)", kn: "PACS ಉಪ-ನಿಯಮಗಳು (MoC)", or: "PACS ଉପ-ନିୟମ (MoC)" },
    category: "bye-laws",
    overview: {
    ...
    applicability: { en: ["PACS registered under the cooperative law of the state."], gu: ["રાજ્યના સહકારી કાયદા હેઠળ નોંધાયેલી PACS."], pa: ["ਰਾਜ ਦੇ ਸਹਿਕਾਰੀ ਕਾਨੂੰਨ ਤਹਿਤ ਰਜਿਸਟਰਡ PACS।"], te: ["రాష్ట్ర సహకార చట్టం కింద నమోదైన PACS."], kn: ["ರಾಜ್ಯದ ಸಹಕಾರ ಕಾಯಿದೆಯ ಅಡಿ ನೋಂದಾಯಿತ PACS."], or: ["ରାଜ୍ୟର ସହକାରୀ ଆଇନ ଅଧୀନରେ ପଞ୍ଜିକୃତ PACS।"] },
