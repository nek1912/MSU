...
export const services: Service[] = [
  {
    ...
    name: { en: "PACS Membership", gu: "PACS સભ્યપદ", pa: "PACS ਮੈਂਬਰਸ਼ਿਪ", te: "PACS సభ్యత్వం", kn: "PACS ಸದಸ್ಯತ್ವ", or: "PACS ସଭ୍ୟପଦ" },
    category: "membership",
    ...
    source: { label: { en: "PACS / Cooperative Department", gu: "PACS / સહકાર વિભાગ", pa: "PACS / ਸਹਿਕਾਰੀ ਵਿਭਾਗ", te: "PACS / సహకార శాఖ", kn: "PACS / ಸಹಕಾರ ಇಲಾಖೆ", or: "PACS / ସହକାର ବିଭାଗ" }, url: "https://www.moc.gov.in" },
  },
  {
    slug: "short-term-crop-credit",
    name: { en: "Short-term Crop Credit", gu: "ટૂંકા ગાળાનો પાક ધિરાણ", pa: "ਥੋੜ੍ਹੇ ਸਮੇਂ ਦਾ ਫਸਲ ਕਰਜ਼ਾ", te: "స్వల్పకాలిక పంట రుణం", kn: "ಅಲ್ಪಾವಧಿ ಬೆಳೆ ಸಾಲ", or: "ସ୍ୱଳ୍ପ ମିଆଦି ଫସଲ ଋଣ" },
    category: "credit",
    ...
    whoCanUse: { en: ["Member farmers of a PACS or cooperative credit institution."], gu: ["PACS અથવા સહકારી ધિરાણ સંસ્થાના સભ્ય ખેડૂતો."], pa: ["PACS ਜਾਂ ਸਹਿਕਾਰੀ ਕ੍ਰੈਡਿਟ ਸੰਸਥਾ ਦੇ ਮੈਂਬਰ ਕਿਸਾਨ।"], te: ["PACS లేదా సహకార క్రెడిట్ సంస్థల సభ్యులు."], kn: ["PACS ಅಥವಾ ಸಹಕಾರ ಕ್ರೆಡಿಟ್ ಸಂಸ್ಥೆಯ ಸದಸ್ಯ ರೈತರು."], or: ["PACS କିମ୍ବା ସହକାରୀ କ୍ରେଡିଟ୍ ସଂସ୍ଥାର ସଭ୍ୟ କୃଷକ।"] },
    ...
    source: { label: { en: "PACS / Bank", gu: "PACS / બેંક", pa: "PACS / ਬੈਂਕ", te: "PACS / బ్యాంకు", kn: "PACS / ಬ್ಯಾಂಕ್", or: "PACS / ବ୍ୟାଙ୍କ" }, url: "https://www.moc.gov.in" },
  },
  {
    slug: "godown-storage",
    name: { en: "Godown & Storage", gu: "ગોદામ અને સંગ્રહ", pa: "ਗੋਦਾਮ ਅਤੇ ਸਟੋਰੇਜ", te: "గోదాము & నిల్వ", kn: "ಗೋದಾಮು ಮತ್ತು ಶೇಖರಣೆ", or: "ଗୋଦାମ ଏବଂ ଭଣ୍ଡାର" },
    category: "storage",
    ...
    source: { label: { en: "PACS / Warehousing", gu: "PACS / ગોદામ", pa: "PACS / ਗੋਦਾਮ", te: "PACS / గోదాము", kn: "PACS / ಗೋದಾಮು", or: "PACS / ଗୋଦାମ" }, url: "https://www.moc.gov.in" },
  },
  {
    slug: "agro-input-supply",
    name: { en: "Agro-input Supply", gu: "કૃષિ સામગ્રી પુરવઠો", pa: "ਖੇਤੀ ਸਮੱਗਰੀ ਸਪਲਾਈ", te: "వ్యవసాయ ఇన్‌పుట్ సరఫరా", kn: "ಕೃಷಿ ಇನ್‌ಪುಟ್ ಸರಬರಾಜು", or: "କୃଷି ସାମଗ୍ରୀ ଯୋଗାଣ" },
    ...
    source: { label: { en: "PACS / Agro-supply", gu: "PACS / કૃષિ પુરવઠો", pa: "PACS / ਖੇਤੀ ਸਪਲਾਈ", te: "PACS / వ్యవసాయ సరఫరా", kn: "PACS / ಕೃಷಿ ಸರಬರಾಜು", or: "PACS / କୃଷି ଯୋଗାଣ" }, url: "https://www.moc.gov.in" },
  },
  {
    slug: "pmfby-enrolment",
    name: { en: "PMFBY Enrolment", gu: "PMFBY નોંધણી", pa: "PMFBY ਦਾਖਲਾ", te: "PMFBY నమోదు", kn: "PMFBY ನೋಂದಣಿ", or: "PMFBY ପଞ୍ଜିକରଣ" },
    category: "insurance",
    ...
    source: { label: { en: "PMFBY", gu: "PMFBY", pa: "PMFBY", te: "PMFBY", kn: "PMFBY", or: "PMFBY" }, url: "https://pmfby.gov.in" },
  },
  {
    slug: "cooperative-subsidy",
    name: { en: "Cooperative Subsidy", gu: "સહકારી સબસિડી", pa: "ਸਹਿਕਾਰੀ ਸਬਸਿਡੀ", te: "సహకార సబ్సిడీ", kn: "ಸಹಕಾರ ಸಬ್ಸಿಡಿ", or: "ସହକାରୀ ସବସିଡି" },
    category: "subsidy",
